...
export const UserMenu: React.FC<UserMenuProp> = ({ cartItems }) => {
  ...
  // TODO style the login button
  if (!currentUser) {
    return (
      <div>
        <NavLink
          className="bg-primary px-2 py-1 font-medium text-white md:px-4 md:py-2"
          role="button"
          type="button"
          to="/signin"
        >
  ...
  return (
    <div className="space-x-2 md:space-x-4">
      ...
      >
        ...
        {cartItems.length > 0 && (
          <div className="absolute inset-0 flex h-6 w-6 translate-x-3/4 translate-y-full items-center justify-center rounded-[50%] bg-secondary text-white">
